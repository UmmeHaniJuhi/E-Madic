    ...
    <script src="{{asset('Admin_Dashboard/js/settings.js')}}"></script>
    <script src="{{asset('Admin_Dashboard/js/todolist.js')}}"></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src="{{asset('Admin_Dashboard/js/dashboard.js')}}"></script>
    <script src="{{asset('Admin_Dashboard/js/Chart.roundedBarCharts.js')}}"></script>
